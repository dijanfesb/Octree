...
LIBS          = $(SUBLIBS) /usr/lib/libQt5Widgets.so /usr/lib/libQt53DExtras.so /usr/lib/libQt53DRender.so /usr/lib/libQt53DInput.so /usr/lib/libQt53DLogic.so /usr/lib/libQt53DCore.so /usr/lib/libQt5Gui.so /usr/lib/libQt5Network.so /usr/lib/libQt5Core.so /usr/lib/libGL.so -lpthread   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		include/vertex.hpp \
		include/objfile.hpp \
		include/faces.hpp src/main.cpp \
		src/guiQt3D.cpp \
		src/faces.cpp \
		src/vertex.cpp \
		src/objfile.cpp
...
distdir: FORCE
	...
	$(COPY_FILE) --parents include/guiQt3D.hpp include/vertex.hpp include/objfile.hpp include/faces.hpp $(DISTDIR)/
	$(COPY_FILE) --parents src/main.cpp src/guiQt3D.cpp src/faces.cpp src/vertex.cpp src/objfile.cpp $(DISTDIR)/
